    ...
    if len(values) == 19 or len(values)==18 :# yellowtaxi_data
        ...
        if (dateset.weekday() in weekend):
            if "Manhattan" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Manhattan,y,weekend\t%d" % (dropoff_hour,1))
            if "Bronx" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Bronx,y,weekend\t%d" % (dropoff_hour,1))
            if "Brooklyn" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Brooklyn,y,weekend\t%d" % (dropoff_hour,1))
            if "Queens" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Queens,y,weekend\t%d" % (dropoff_hour,1))
            if "Staten Island" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Staten Island,y,weekend\t%d" % (dropoff_hour,1))
        else:
            if "Manhattan" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Manhattan,y,weekday\t%d" % (dropoff_hour,1))
            if "Bronx" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Bronx,y,weekday\t%d" % (dropoff_hour,1))
            if "Brooklyn" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Brooklyn,y,weekday\t%d" % (dropoff_hour,1))
            if "Queens" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Queens,y,weekday\t%d" % (dropoff_hour,1))
            if "Staten Island" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Staten Island,y,weekday\t%d" % (dropoff_hour,1))
        ...
        if (dateset.weekday() in weekend):
            if "Manhattan" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Manhattan,g,weekend\t%d" % (dropoff_hour,1))
            if "Bronx" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Bronx,g,weekend\t%d" % (dropoff_hour,1))
            if "Brooklyn" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Brooklyn,g,weekend\t%d" % (dropoff_hour,1))
            if "Queens" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Queens,g,weekend\t%d" % (dropoff_hour,1))
            if "Staten Island" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Staten Island,g,weekend\t%d" % (dropoff_hour,1))
        else:
            if "Manhattan" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Manhattan,g,weekday\t%d" % (dropoff_hour,1))
            if "Bronx" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Bronx,g,weekday\t%d" % (dropoff_hour,1))
            if "Brooklyn" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Brooklyn,g,weekday\t%d" % (dropoff_hour,1))
            if "Queens" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Queens,g,weekday\t%d" % (dropoff_hour,1))
            if "Staten Island" in neighborhoods[dropoff_neighborhood][0]:
                print ("%s,Staten Island,g,weekday\t%d" % (dropoff_hour,1))
